package com.lmaye.spring.boot.cache.guava.config;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        ...
        tokenPar.name("Authorization").description("令牌").modelRef(new ModelRef("string"))
                .parameterType("header").required(true).defaultValue("Token For Guava Cache");
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //选择controller包
                .apis(RequestHandlerSelectors.basePackage("com.lmaye.spring.boot.cache.guava.controller"))
