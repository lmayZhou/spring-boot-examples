# Spring Boot Docker(2.x版本)

### 项目介绍
&emsp;&emsp;Spring Boot(2.x版本) 整合 Docker实例，简单的实现基本的IDEA + Dockerfile远程部署容器和Docker Compose的集群部署项目;
Docker整合实践案例，仅供学习参考！如有更好的方案和idea，欢迎互相交流！如您觉得该项目对您有所帮助，欢迎点击右上方的Star标记，给予支持！！！谢谢 ~ ~
...
### 参与贡献
1. 2019年06月1日: 构建 spring-boot-docker [Module]
2. 2019年06月1日: 初始化 spring-boot-dockerfile [项目]
3. 2019年06月2日: 初始化 spring-boot-docker-compose [项目]
